      ...
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item :rules="[{ required: true, message: '请输入验证码', trigger: 'blur' }]" class="input-prepend restyle no-radius" prop="code">
          ...
          <div class="btn" style="position:absolute;right: 0;top: 6px;width: 40%;">
            <a :value="codeTest" href="javascript:" type="button" style="border: none;background-color: #FFFFFF" @click="getCodeFun()">{{ codeTest }}</a>
          </div>
        </el-form-item>
...
import registerApi from '@/api/toregister'
